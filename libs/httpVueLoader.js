        ...
        compile: function(module) {
            var childModuleRequire = function(childUrl) {
                ...
                return httpVueLoader.require(
                    (isRelative ? this.component.baseURI : '') + childUrl,
                );
            }.bind(this);
            ...
            try {
                ...
                var lineNumber =
                    vueFileData
                        .substr(0, vueFileData.indexOf(script))
                        .split('\n').length +
                    ex.lineNumber -
                    1;
    ...
    function parseComponentURL(url) {
        ...
        return {
            ...
            url:
                comp[1] +
                comp[2] +
                (comp[3] === undefined ? '/home.vue' : comp[3]),
        };
    }
                ...
                .then(function(component) {
                    var exports =
                        component.script !== null
                            ? component.script.module.exports
                            : {};
                ...
                for (var componentName in components) {
                    if (
                        ...
                        var comp = parseComponentURL(
                            components[componentName].substr(4),
                        );
                        ...
                        if (isNaN(componentName))
                            ...
                            components[componentName] = Vue.component(
                                comp.name,
                                httpVueLoader.load(comp.url, comp.name),
                            );
                    }
                }
            },
